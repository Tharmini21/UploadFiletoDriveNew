...
export declare class RenewOAuth2TokenResponse extends AbstractResponse implements SerializableClass {
    access_token: string;
    token_type?: string;
    refresh_token?: string;
    expires_in?: number;
    grant_type?: string;
    metadata?: Record<string, string>;
    static create(props?: Partial<RenewOAuth2TokenResponse>): RenewOAuth2TokenResponse;
    constructor({ status, access_token, token_type, refresh_token, expires_in, grant_type, metadata, }?: Partial<RenewOAuth2TokenResponse>);
...
//# sourceMappingURL=RenewOAuth2TokenResponse.d.ts.map