...
const StartOAuth2Response_1 = require("@smartsheet-bridge/extension-handler/lib/responses/StartOAuth2Response");
...
const onOAuthStart = () => {
    ...
    function getAuthenticateButton() {
        const msg = '<p>To link this integration with a specific account authenticate with your Google Drive account.</p>';
    ...
    const response = new StartOAuth2Response_1.StartOAuth2Response();
