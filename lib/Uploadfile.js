...
const {
  google
} = require('googleapis'); // const DataUri = require("datauri");


const request = require('request');

const Uploadfile = (moduleParams, context) => {
  ...
  request(moduleParams.filepath, function (error, response, body) {
  ...
  console.log("ImagePath", moduleParams.filepath); // const finalPath = path.resolve(__dirname, moduleParams.filepath);
  ...
  console.log(driveClient.files.create({
    ...
    media: {
      mimeType: moduleParams.mimetype,
      body: _fs.default.createReadStream('C:/Users/Tharmini/Pictures/Screenshots/Screenshot (42).png')
    },
